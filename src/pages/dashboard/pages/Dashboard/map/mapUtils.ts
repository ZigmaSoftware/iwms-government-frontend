...
export const VEHICLE_STATUS_META: Record<
  ...
  { labelKey: string; color: string; bg: string }
> = {
  active: { labelKey: "common.active", color: "#15803d", bg: "rgba(34,197,94,0.18)" },
  inactive: { labelKey: "common.inactive", color: "#64748b", bg: "rgba(100,116,139,0.18)" },
};

export const createVehicleIcon = (status: VehicleStatus, isFocused = false) => {
